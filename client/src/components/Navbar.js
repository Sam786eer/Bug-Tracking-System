...
const Navbar = () => {
  ...
  // Renders menu options dynamically
  const renderedList = () => {
    if (state) {
      return [
        <li key="1">
          <Link to="/profile" className="link-title">
            My Profile
          </Link>
        </li>,
        <li key="2">
          <Link to="/subscribedposts" className="link-title">My Team's Tickets</Link>

        </li>,
        <li key="3">
          <Link to="/alltickets" className="link-title">
            All Tickets
          </Link>
        </li>,
        <li key="4">
          <Link to="/createpost" className="link-title">
            Create New Ticket
          </Link>
        </li>,
        <li key="5">
        ...
        <ul id="nav-mobile" className="right menu">
          {window.innerWidth < 960 ? (
            <Dropdown
              ...
              trigger={
                <Button style={{ marginRight: "20px" }} node="button">
                  Options
                </Button>
              }
            >
